...
export class UtilService {
  ...
  private foodChanges = new Subject<any>();
  private orderChanges = new Subject<any>();
  ...
  onFoodChanged() {
    this.foodChanges.next(0);
  };

  subscribeFoodChanges(): Subject<any> {
    return this.foodChanges;
  };

  onOrderChanges() {
    this.orderChanges.next(0);
  }

  subscribeOrderChange(): Subject<any> {
