...
export class ContactsPage implements OnInit {
  ...
  constructor(
    ...
    console.log('address-->>', this.util.generalSettings.address);
    if (this.util.appSettings && this.util.generalSettings.address) {
      const geocoder = new google.maps.Geocoder;
      geocoder.geocode({
        address: this.util.generalSettings.address + ' ' + this.util.generalSettings.city + ' ' +
          this.util.generalSettings.state + ' ' + this.util.generalSettings.country + ' ' + this.util.generalSettings.zip
