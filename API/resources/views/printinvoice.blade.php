		...
		<tbody>
			<tr>
				<td>
									...
									<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content"
										...
										<tbody>
											<tr>
												...
												<td class="column"
													style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-right: 15px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
													width="25%">
								...
								<td>
									<table align="center" border="0" cellpadding="0" cellspacing="0"
										...
										<tbody>
											<tr>
												<td class="column"
													style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-left: 10px; padding-right: 10px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
															...
															<td
																...
																<div style="font-family: sans-serif">
																	<div
																		style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #44464a; line-height: 1.2; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;">
																		<p style="margin: 0; font-size: 14px;">Order
																			To: <span style="text-transform:uppercase">Home</span> </p>
																	</div>
																</div>
															</td>
														</tr>
								...
								<td>
									<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content"
										...
										<tbody>
											<tr>
												<td class="column"
													style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; background-color: #f9feff; padding-left: 15px; padding-right: 15px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
													width="33.333333333333336%">
													<table border="0" cellpadding="0" cellspacing="0" class="text_block"
														role="presentation"
														style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;"
															...
															<td
																...
																<div style="font-family: sans-serif">
																	<div
																		...
																		<p style="margin: 0; font-size: 14px;">Item</p>
																	</div>
																</div>
															</td>
														</tr>
                    ...
                    @if($order->size == 1)
                        @foreach($order->selectedItem as $savedCartItem)
                                                                        ...
                                                                        <div style="font-family: sans-serif">
                                                                            <div
                                                                                ...
                                                                                <p style="margin: 0; font-size: 14px;">
                                                                                    {{$order->name}}
                                                                                    <p>
                                                                                        @foreach($savedCartItem->item as $subProduct)
                                                                                            - {{$subProduct->name}} <br>
                                                                                        @endforeach
                                                                                    </p>
                                                                                </p>
                                                                        ...
                                                                        <div style="font-family: sans-serif">
                                                                            <div
                                                                                ...
                                                                                <p style="margin: 0; font-size: 14px; text-align: right;">
                                                                                    ...
                                                                                    <p style="margin: 0; font-size: 14px; text-align: right;">
                                                                                        @foreach($savedCartItem->item as $subProduct)
                                                                                            {{$currencySymbol}} {{$subProduct->value}} <br>
                                                                                        @endforeach
                                                                                    </p>
                                                                                </p>
															...
															<td
																...
																<div style="font-family: sans-serif">
																	<div
																		...
																		<p
																			style="margin: 0; font-size: 14px; text-align: right;">
																			<span style="font-size:16px;">{{$currencySymbol}}
																				{{$data->total}}</span>
																		</p>
																	</div>
																</div>
															...
															<td
																...
																<div style="font-family: sans-serif">
																	<div
																		style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #393d47; line-height: 1.2; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;">
																		<p style="margin: 0; font-size: 14px;"><span
																				style="font-size:16px;"><strong>Discount</strong></span>
																		</p>
																	</div>
																</div>
															</td>
															...
															<td
																...
																<div style="font-family: sans-serif">
																	<div
																		style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #393d47; line-height: 1.2; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;">
																		<p style="margin: 0; font-size: 14px;"><span
																				style="font-size:16px;"><strong>Wallet Amount</strong></span>
																		</p>
																	</div>
																</div>
															</td>
								...
								<td>
									<table align="center" border="0" cellpadding="0" cellspacing="0"
										...
										<tbody>
											<tr>
												<td class="column"
													style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-left: 5px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
													width="100%">
													<table border="0" cellpadding="10" cellspacing="0"
														class="text_block" role="presentation"
														style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;"
																	...
																	<div
																		...
																		<p
																			...
																			<span style="font-size:22px;"><strong><span
																						style="">Grand Total {{$currencySymbol}}
