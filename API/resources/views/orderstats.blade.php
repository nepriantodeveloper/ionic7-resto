															...
															<td
																...
																<div style="font-family: sans-serif">
																	<div
																		...
																		<p style="margin: 0; font-size: 14px;">Stats
																			Date: {{$from_date}} {{$end_date}} </p>
																	</div>
																</div>
															</td>
														</tr>
																...
																<div style="font-family: sans-serif">
																	<div
																		...
																		<p style="margin: 0; font-size: 14px;">
																			Address: <span style="text-transform:capitalize">{{$address}}</span> </p>
																	</div>
																</div>
															</td>
														</tr>
															...
															<td
																...
																<div style="font-family: sans-serif">
																	<div
																		style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #393d47; line-height: 1.2; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;">
																		<p style="margin: 0; font-size: 14px;"><span
																				style="font-size:16px;"><strong>Commission</strong></span>
																		</p>
																	</div>
																</div>
															</td>
															...
															<td
																...
																<div style="font-family: sans-serif">
																	<div
																		style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #393d47; line-height: 1.2; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;">
																		<p style="margin: 0; font-size: 14px;"><span
																				style="font-size:16px;"><strong>Amount Received</strong></span>
																		</p>
																	</div>
																</div>
															</td>
